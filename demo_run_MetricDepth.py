...
torch_model.load_state_dict(torch.load(f'DepthAnythingV2/checkpoints/depth_anything_v2_metric_hypersim_{encoder}.pth', map_location='cpu'))
...
compile_job = hub.submit_compile_job(
    name=f'depth_anything_v2_metric_{encoder}_336x336',
...
cv2.imwrite(f'test_tea_metric_{encoder}_336x336.png', depth)
#########################################################################################################
